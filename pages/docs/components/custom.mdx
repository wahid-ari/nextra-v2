	...
	return (
		<div className="flex items-center gap-2">
			...
			<button onClick={() => setCount(0)}
				className="bg-red-500 hover:bg-red-600 transition-all duration-200 font-medium px-1.5 py-0.5 rounded text-sm"	
			>
				Reset
			</button>
		</div>
...
<div className="mt-4 p-4 rounded border dark:border-neutral-800">
	<Counter>
		<span className="bg-blue-500 hover:bg-blue-600 transition-all duration-200 font-medium px-1.5 py-0.5 rounded text-sm">Click Me !</span>{" "}:
	</Counter>
</div>
```
