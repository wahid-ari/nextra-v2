import Code, { BadgeCode } from '@components/Code'

# Sandpack

[Sandpack](https://sandpack.codesandbox.io/) is a component toolkit for creating live-running code editing experiences powered by [CodeSandbox](https://codesandbox.io/).
...
```jsx filename="components/Code.js"
